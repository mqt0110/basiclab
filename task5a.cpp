    ...
    int &modify(int dpi, char* keyword1, char* keyword2, char*keyword3, char* name)
{
    ...
    Lensman& operator = (const Lensman & x) // assignment operator- passed in pointer
    {

        Photo *oldlist=x.head; // con tro list goc

        if (this == &x)
            return *this;


            // lam sach con tro this
           this->~Lensman(); // clear *this

            //copy tu optr den cptr
            while(oldlist)
            {
                this->add_Photo(oldlist->dpi,oldlist->keyword1,oldlist->keyword2,oldlist->keyword3,oldlist->name);
                oldlist=oldlist->next;
            }


        cout<<"Assignment operator Finished"<<endl;
        return *this;

    }


   Lensman (const Lensman& x)  //copy constructor  // passed in pointer
        {

            Photo *oldlist=x.head; // con tro list goc
            this->head=NULL;
            while(oldlist) // duyet con tro goc tu phan tu thu hai
            {
           ...
           cout<<"Copy constructor finished"<<endl;  // test
}

    Lensman operator +(const Lensman &x) // c=a+b ,  b=x  => a:list 1(con tro this), b:list2  -- copy list2 vao list 1    /// passed
    {
        Lensman *newlist=new Lensman(*this);
        Photo *currentlist1=this->head;
        Photo *currentlist2=x.head;

        int a,b,c,d,b1,b2,b3,c1,c2,c3,d1,d2,d3;
        int mark;

        if(!(currentlist1)) // list 1 trong
        {
            *newlist=x;
        }
        if ((currentlist1) && (currentlist2) )
            {
                ...
                while(currentlist2)
                {
                    ...
                    while(currentlist1)
                    {
                         ...
                         //CHECK NAME VA KEYWORD
            a=strcmp(currentlist1->name,currentlist2->name);

            b1=strcmp(currentlist1->keyword1,currentlist2->keyword1);
            b2=strcmp(currentlist1->keyword1,currentlist2->keyword2);
            b3=strcmp(currentlist1->keyword1,currentlist2->keyword3);

            c1=strcmp(currentlist1->keyword2,currentlist2->keyword1);
            c2=strcmp(currentlist1->keyword2,currentlist2->keyword2);
            c3=strcmp(currentlist1->keyword2,currentlist2->keyword3);

            d1=strcmp(currentlist1->keyword3,currentlist2->keyword1);
            d2=strcmp(currentlist1->keyword3,currentlist2->keyword2);
            d3=strcmp(currentlist1->keyword3,currentlist2->keyword3);
        ...
        //1:cung key va ten
                ...
                {
                    mark=-1;
                    break; //dung duyt while(currentlist1)
                }// dau if
        //2: khac ten hoac key
                else
                {
                    ...
                    }// dau while(currentlist1)

                if(mark == 0)
                    {
                        newlist->add_Photo(currentlist2->dpi,currentlist2->keyword1,currentlist2->keyword2,currentlist2->keyword3,currentlist2->name);

                    }
                else
                   {
                        newlist->modify(currentlist2->dpi,currentlist2->keyword1,currentlist2->keyword2,currentlist2->keyword3,currentlist2->name);// change dpi

                   }
                    currentlist2=currentlist2->next;
                }//dau  while(currentlist2)
...
return *newlist;
     ...
     Lensman operator -(const Lensman &x)  // c=a-b ,  b=x  => a:list 1(con tro this), b:list2s
    {
            Lensman *newlist=new Lensman(*this); //copy constructor;
            Photo *currentlist1=this->head;
            Photo *currentlist2=x.head;
        ...
        // cung ten va key
            if( (a == 0) && ( b==0)&& (c==0) && (d==0) )
            {
                ...
                newlist->remove_Photo(currentlist1->code);
                break; // ngung duyet
            }
            else
                currentlist1=currentlist1->next; // duyet tiep neu khong cung ten va keyword

                } // dau while(currentlist1)
                currentlist2= currentlist2->next;
            }// dau while(currenlist2)

        return *newlist;

    }
 //   friend Lensman& operator-(const Lensman&, const Lensman&);
    Lensman()
    {
        head=NULL;
    }
...
/*
    ...
    Lensman *p2=new Lensman;
    Lensman *p3=new Lensman;
    Lensman *p4=new Lensman;
    /////////////////List 1////////////////////////////////////////////
    ...
    p1->add_Photo(100,(char *) "slo",(char *) "anima",(char *) "move",(char *) "Horse riding");
    p1->print();
    ///////////////////////////////////////////////////////////////////
    ...
    p2->add_Photo(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse riding");
    p2->add_Photo(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding");
    p2->add_Photo(100,(char *) "fast",(char *) "anima",(char *) "move",(char *) "Horse riding");
    p2->print();
*/
    ///////////////////////////////////////////////////////////////////
////////////////////operator + test/////////////
