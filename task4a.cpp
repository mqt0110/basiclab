...
/*
    ...
    p11.print();
     cout<<"Test"<<endl<<endl;
    p.modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride12355"); ////change name of photo code 1 in p
    p.modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 566");  //change name of photo code 2 in p
    p11.print();
    p11.modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride125"); //change name of photo code 2 in p11
    p11.modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 564dad6"); //change name of photo code 2 in p11
    p.print();
...
///////////////////////////
    ...
    ////test copy constructor - done-passed
/*
      Lensman p12=p;
    p12.print();
     cout<<"Test"<<endl<<endl;
    ...
    p.modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 566");  //change name of photo code 2 in p
    p12.print();
    p12.modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride125"); //change name of photo code 2 in p11
    p12.modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 564dad6"); //change name of photo code 2 in p11
    p.print();
...
/*
    ...
    p1->add_Photo(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse riding"); // code :1
    p1->add_Photo(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding");//new Photo code 2
    ...
    p1->modify(100,(char *) "fast",(char *)"animal",(char *) "move",(char *) "Horse riding"); //creation of a new Photo code:3
    p1->modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride"); //name substitution
    p1->print();
*/
  ////test assignment operator - done - passed //////////////////////////

/*
    Lensman *p2 = new Lensman;// new Lensman;
    p2=p1;
    p2->print();

     cout<<"Test"<<endl<<endl;
    p1->modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride12355"); ////change name of photo code 1 in p1
    p1->modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 566");  //change name of photo code 2 in p1
    p2->print();
    p2->modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride125"); //change name of photo code 1 in p2
    p2->modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 564dad6"); //change name of photo code 2 in p2
    p1->print();
...
/*
     Lensman *p3 = new Lensman (*p1);
    p3->print();
    cout<<"Test"<<endl<<endl;
    p1->modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride12355"); ////change name of photo code 1 in p1
    p1->modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 566");  //change name of photo code 2 in p1
    p3->print();
    p3->modify(100,(char *) "slow",(char *) "animal",(char *) "move",(char *) "Horse-ride125"); //change name of photo code 1 in p3
    p3->modify(100,(char *) "slo",(char *) "animal",(char *) "move",(char *) "Horse riding 564dad6"); //change name of photo code 2 in p3
    p1->print();
*/
    //////////////////
////////////////////////////////////
